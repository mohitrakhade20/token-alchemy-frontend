...
export default function ReadERC20(props:Props){
  ...
  return (
    ...
    <FormControl>
    <FormLabel htmlFor='contractaddress'>Token contract adddress: </FormLabel>
      <Input id="contractaddress" type="text" required  onChange={(e) => setAddressContract(e.target.value)} my={3}/>
